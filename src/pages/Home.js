...
import CardSlider from "../component/home/card/CardSlider";

// import Models from "./../model/Models";
import Models from "../component/home/model/Models"
...
const Home = () => {
  ...
  const QuickitemsList = [
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/50-watt-soldering-iron-siron/50-watt-soldering-iron-siron-1%20(3)-550x550.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/solder-wire-40-gsm-for-most-electrical-repair-soldering-purpose/solder-wire-40-gsm-for-most-electrical-repair-soldering-purpose1-550x550.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/m3-ss-hex-nut-10pcs/m3-ss-hex-nut-10pcs-550x550w.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gJ/m3x6mm-pan-philips-head-screw-10pcs/m3x6mm-pan-philips-head-screw-10pcs-550x550w.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/allen-kay/allen-key-2.5mm-550x550w.webp",
      des: "Allen Key 2.5mm",
      price: "19",
      steacker: "0",
    },
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/allen-key-3mm/allen-key-3mm3-550x550.webp",
      des: "Allen Key 3mm",
      price: "29",
      steacker: "0",
    },
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/noel-50w-solder-iron-bit/noel-50w-solder-iron-bit-550x550h.webp",
  ...
  const MultirotorsListitem = [
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gp/rc-aeroplane-kit-motor-plus-esc-plus-propeller-plus-servo-plus-tx-rx/rc-aeroplane-kit-motor-plus-esc-plus-propeller-plus-servo-plus-tx-rx-550x550.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/drone-accessories-combo-4-x-motorand-4-x-escand-2-x-1045-propellerand-1-x-f450-frameand-strap-belt/drone-accessories-combo-4-x-motorand-4-x-escand-2-x-1045-propellerand-1-x-f450-frameand-strap-belt1-550x550.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/hexacopter-drone-accessories-combo-6-x-motorand-6-x-escand-3-x-1045-propellerand-1-x-f550-frameand-strap-belt/hexacopter-drone-accessories-combo-6-x-motorand-6-x-escand-3-x-1045-propellerand-1-x-f550-frameand-strap-belt1-550x550.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/rc-aeroplane-kit-motor-plus-esc-plus-propeller-plus-servo-plus-tx-rx-fsi6/rc-aeroplane-kit-motor-plus-esc-plus-propeller-plus-servo-plus-tx-rx-fsi6-550x550.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/quadcopter-drone-combo-with-radiolink-crossflight/quadcopter-drone-combo-with-radiolink-crossflight-550x550.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/hexacopter-drone-combo-with-radiolink-crossflight-kit2/hexacopter-drone-combo-with-radiolink-crossflight-kit21-550x550.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/combo/Drone-combo-pixhawk3-550x550.webp",
  ...
  const FlightControllerList = [
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gp/arducopter-apm-2.8-flight-control-board-for-rc-multi-rotor-drone/arducopter-apm-2.8-flight-control-board-for-rc-multi-rotor-drone-550x550.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/product2/kk2.1.5-lcd-flight-controll-board-for-fpv-racing-drone-550x550.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/FlySky-FS-CT6B-FS-CT6B-24G-6CH-Radio-Set-System--TX-FS-CT6B--RX-FS-R6B-/flysky-fs-ct6b-2.4g-6ch-radio-set-system-with-rx-fs-r6b-receiver2-550x550.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/pixhawk_px4_32bits_flight_controller/pixhawk_px4_32bits_flight_controller-5-550x550w.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/Pixhawk-PIX-248--PX4-Autopilot-PIX-248-32-Bit-Flight-Controller-with-Sa/pixhawk-combo-550x550.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/FlySky-FS-i6-2.4G-6CH-AFHDS-Transmitter-With-FS-iA6B-Receiver/flysky-fs-ia6-6ch-afhds-2a-2.4g-radio-receiver-550x550.webp",
  ...
  const Ebikelist = [
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/my1016-250w-24v-dc-motor-with-gear-for-e-bike-electric-bicycle-original-unite/my1016-250w-24v-dc-motor-with-gear-for-e-bike-electric-bicycle-original-unite-3-550x550.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/twist-throttle-grip-accelerator-for-e-bike/twist-throttle-grip-accelerator-for-e-bike-550x550h.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/electric-cycle/my1016-350w-motor-+-motor-controller-+-twist-throttle-for-diy-electric-bicycle-kit-550x550.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gp/electric-cycle/TECH1083_a_1024x1024-550x550w.webp",
    ...
    {
      image:
        "https://www.flyrobo.in/image/cache/wp/gj/electric-cycle/my1016-250w-motor-+-motor-controller-+-twist-throttle-for-diy-electric-bicycle-kit-550x550h.webp",
  ...
  return (
    ...
    <Models
        ...
        imageSrc="image.jpg"
        title="Image Title"
        description="This is a detailed description of the image. You can add any information you want here."
      />
      ...
      <div className="home_container">
        <div className="home-wraper">
          ...
          <div className="cardComponent">
            <CardSlider items={itemsL} open={handleOpenModal} />
          </div>
          <div className="Quick-Pick">
            <CardSlider items={QuickitemsList} open={handleOpenModal}/>
          </div>

          <div className="Quick-Pick">
            <CardSlider items={LikeitemsList} open={handleOpenModal}/>
          </div>
          <div className="Quick-Pick">
            <CardSlider items={ArduinoList} open={handleOpenModal}/>
          </div>
          <div className="Quick-Pick">
            <CardSlider items={MultirotorsListitem} open={handleOpenModal}/>
          </div>
          <div className="Quick-Pick">
            <CardSlider items={FlightControllerList} open={handleOpenModal}/>
          </div>
          <div className="Quick-Pick">
            <CardSlider items={Ebikelist} open={handleOpenModal} />
          </div>
